...
static_assert(
    [] {
        ddge::util::BasicAnyFunction<void(), 0z>{ throwing_function };
...
static_assert(
    [] {
        ddge::util::BasicAnyFunction<void(Dummy), 0z>{ &Dummy::method };
...
static_assert(
    [] {
        ddge::util::BasicAnyFunction<void(), 0z>{ [] {} };
...
static_assert(
    [] {
        ddge::util::BasicAnyFunction<void(), 0z>{ [] static {} };
...
static_assert(
    std::constructible_from<
        ddge::util::BasicAnyFunction<void() noexcept, 0z>,
...
static_assert(
    [] {
        ddge::util::BasicAnyFunction<void(), 0z> any_function{ throwing_function };
...
static_assert(
    []<typename AnyFunction_T> {
        ...
        return true;
    }.operator()<ddge::util::BasicAnyFunction<void() &, 0z>>(),
    "& call"
);
...
static_assert(
    std::is_nothrow_invocable_v<ddge::util::BasicAnyFunction<void() noexcept, 0z>>,
    "noexcept call"
);

static_assert(
    !std::is_nothrow_invocable_v<ddge::util::BasicAnyFunction<void(), 0z>>,
    "throwing call"
);
