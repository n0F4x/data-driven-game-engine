...
Device::Device(
    ...
    : m_instance{ utils::create_instance(
      ...
      m_device{ create_device(m_surface, m_physical_device) },
      m_graphics_queue_family{
          find_queue_families(*m_surface, *m_physical_device)
              .value()
              .graphics_family
      },
      m_present_queue_family{ find_queue_families(*m_surface, *m_physical_device)
                                  .value()
                                  .present_family },
