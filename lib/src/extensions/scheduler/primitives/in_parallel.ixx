...
export module extensions.scheduler.primitives.in_parallel;
...
[[nodiscard]]
auto in_parallel(TaskBuilders_T&&... task_builders) -> core::scheduler::TaskBuilder<void>;
...
auto extensions::scheduler::primitives::in_parallel(TaskBuilders_T&&... task_builders)
