...
export module extensions.scheduler.argument_providers.ecs.ArgumentProvider;
...
namespace extensions::scheduler::argument_providers::ecs {

export class ArgumentProvider {
public:
    explicit ArgumentProvider(core::ecs::Registry& registry);
...
extensions::scheduler::argument_providers::ecs::ArgumentProvider::ArgumentProvider(
...
auto extensions::scheduler::argument_providers::ecs::ArgumentProvider::provide() const
    -> std::remove_cvref_t<Accessor_T>
{
