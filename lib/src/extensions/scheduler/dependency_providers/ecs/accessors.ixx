...
export module extensions.scheduler.dependency_providers.ecs.accessors;

import core.ecs;

namespace extensions::scheduler::dependency_providers::ecs::accessors {
...
template <core::ecs::query_parameter_c... Parameters_T>
    requires(sizeof...(Parameters_T) != 0)
extensions::scheduler::dependency_providers::ecs::accessors::Query<Parameters_T...>::Query(
...
template <core::ecs::query_parameter_c... Parameters_T>
    requires(sizeof...(Parameters_T) != 0)
template <typename F>
auto extensions::scheduler::dependency_providers::ecs::accessors::Query<Parameters_T...>::
