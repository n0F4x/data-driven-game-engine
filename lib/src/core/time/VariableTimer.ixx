...
core::time::VariableTimer<Duration_T>::VariableTimer(const Duration_T tick_duration)
    : m_tick_duration{ tick_duration }
{}

template <util::meta::specialization_of_c<std::chrono::duration> Duration_T>
auto core::time::VariableTimer<Duration_T>::delta_ticks() const -> uint32_t
{
    return static_cast<uint32_t>(std::floor(m_delta_time / m_tick_duration));
}

template <util::meta::specialization_of_c<std::chrono::duration> Duration_T>
auto core::time::VariableTimer<Duration_T>::current() const -> Clock::time_point
{
    return m_current;
}

template <util::meta::specialization_of_c<std::chrono::duration> Duration_T>
auto core::time::VariableTimer<Duration_T>::tick_duration() const -> Duration_T
{
    return m_tick_duration;
}

template <util::meta::specialization_of_c<std::chrono::duration> Duration_T>
auto core::time::VariableTimer<Duration_T>::adjust_tick_duration(
...
template <util::meta::specialization_of_c<std::chrono::duration> Duration_T>
auto core::time::VariableTimer<Duration_T>::update(const Clock::time_point current)
    -> void
{
    if (delta_ticks() >= 1) {
...
template <util::meta::specialization_of_c<std::chrono::duration> Duration_T>
auto core::time::VariableTimer<Duration_T>::reset(const Clock::time_point current) -> void
{
    m_current    = current;
    m_delta_time = Delta{};
}
