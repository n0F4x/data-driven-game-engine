...
export module core.ecs:ArchetypeInfo;
...
public:
    template <core::ecs::component_c... Components_T>
    consteval explicit ArchetypeInfo(util::TypeList<Components_T...>)
        : m_id{ util::meta::id_v<
              sorted_component_id_sequence_t<component_id<Components_T>.underlying()...>> },
          m_sorted_component_ids{ make_component_id_set<Components_T...>() }
    {}

    constexpr auto operator==(const ArchetypeInfo& other) const noexcept -> bool
    {
        return m_id == other.m_id;
    }

    constexpr auto operator<=>(const ArchetypeInfo& other) const noexcept
    {
        return m_id <=> other.m_id;
    }
...
struct ArchetypeInfoHashAdaptorClosure {
    [[nodiscard]]
    constexpr static auto operator()(const ArchetypeInfo& archetype) noexcept -> size_t
    {
...
template <>
struct std::hash<ArchetypeInfo> {
    [[nodiscard]]
    constexpr static auto operator()(const ArchetypeInfo& archetype) noexcept
        -> std::size_t
    {
...
template <core::ecs::component_c... Components_T>
[[nodiscard]]
constexpr auto archetype_from() noexcept -> const ArchetypeInfo&
{
    constexpr static ArchetypeInfo archetype{ util::TypeList<Components_T...>{} };
