...
module core.renderer.SurfaceInjection;
...
auto core::renderer::SurfaceInjection::operator()(
...
auto core::renderer::SurfaceInjection::setup(InstanceInjection& instance_injection)
    -> void
{
