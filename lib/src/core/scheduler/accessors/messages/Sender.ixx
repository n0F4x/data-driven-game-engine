...
export module core.scheduler.accessors.messages.Sender;
...
template <core::messages::message_c... Messages_T>
    requires(sizeof...(Messages_T) != 0)
constexpr core::scheduler::accessors::messages::Sender<Messages_T...>::Sender(
    core::messages::MessageBuffer<Messages_T>&... message_buffers
)
...
template <typename... Args_T>
    requires(sizeof...(Messages_T) == 1)
         ...
         && std::constructible_from<
                util::meta::type_list_front_t<util::TypeList<Messages_T...>>,
                Args_T&&...>
constexpr auto core::scheduler::accessors::messages::Sender<Messages_T...>::send(
    Args_T&&... args
) const -> void
{
