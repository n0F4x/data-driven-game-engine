...
export module core.scheduler.SchedulerBuilder;
...
template <typename TaskBuilder_T>
    requires core::scheduler::
          ...
          && std::same_as<typename std::remove_cvref_t<TaskBuilder_T>::Result, void>
core::scheduler::SchedulerBuilder::SchedulerBuilder(TaskBuilder_T&& task_builder)
    : m_builder{ std::forward<TaskBuilder_T>(task_builder) }
{}

template <typename Self_T>
core::scheduler::SchedulerBuilder::operator TaskBuilder<void>(this Self_T && self)
{
...
template <typename Self_T, typename TaskBuilder_T>
    requires core::scheduler::
                 specialization_of_TaskBuilder_c<std::remove_cvref_t<TaskBuilder_T>>
          && std::same_as<typename std::remove_cvref_t<TaskBuilder_T>::Result, void>
auto core::scheduler::SchedulerBuilder::then(
    this Self_T&&   self,
...
template <typename Self_T, typename ScheduleBuilder_T>
    requires std::
        same_as<std::remove_cvref_t<ScheduleBuilder_T>, core::scheduler::SchedulerBuilder>
    auto core::scheduler::SchedulerBuilder::then(
        this Self_T&&       self,
...
auto core::scheduler::SchedulerBuilder::build(Nexus& nexus) const -> Task<void>
{
