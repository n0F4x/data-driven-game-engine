...
export module core.scheduler.task_builders.GroupedTaskBuilder;
...
public:
    ...
    constexpr explicit GroupedTaskBuilder(UTaskBuilders_T&&... task_builders);
...
template <typename... UTaskBuilders_T>
    requires(std::constructible_from<TaskBuilders_T, UTaskBuilders_T &&> && ...)
constexpr core::scheduler::GroupedTaskBuilder<TaskBuilders_T...>::GroupedTaskBuilder(
...
template <core::scheduler::task_builder_c... TaskBuilders_T>
template <typename Self_T, typename... ArgumentProviders_T>
constexpr auto core::scheduler::GroupedTaskBuilder<TaskBuilders_T...>::operator()(
    this Self_T&& self,
