...
export module core.scheduler.providers.EventProvider;
...
import core.scheduler.accessors.events;
...
template <>
struct core::scheduler::ProviderOf<addons::Events>
    : std::type_identity<core::scheduler::providers::EventProvider> {};

template <>
struct core::scheduler::ProviderFor<core::scheduler::accessors::events::Processor>
    : std::type_identity<core::scheduler::providers::EventProvider> {};

template <typename... Events_T>
struct core::scheduler::
    ProviderFor<core::scheduler::accessors::events::Recorder<Events_T...>>
    : std::type_identity<core::scheduler::providers::EventProvider> {};

template <typename Event_T>
struct core::scheduler::
    ProviderFor<core::scheduler::accessors::events::Reader<Event_T>>
    : std::type_identity<core::scheduler::providers::EventProvider> {};

template <app::has_addons_c<addons::Events> App_T>
constexpr core::scheduler::providers::EventProvider::EventProvider(App_T& app)
    : m_event_manager_ref{ app.event_manager }
{}

template <std::same_as<core::scheduler::accessors::events::Processor> Accessor_T>
auto core::scheduler::providers::EventProvider::provide() const
    -> core::scheduler::accessors::events::Processor
{
    return core::scheduler::accessors::events::Processor{ m_event_manager_ref };
}

template <util::meta::specialization_of_c<
    core::scheduler::accessors::events::Recorder> Recorder_T>
constexpr auto core::scheduler::providers::EventProvider::provide() const
    -> Recorder_T
{
...
template <util::meta::specialization_of_c<core::scheduler::accessors::events::Reader>
              Reader_T>
constexpr auto core::scheduler::providers::EventProvider::provide() const
    -> Reader_T
{
