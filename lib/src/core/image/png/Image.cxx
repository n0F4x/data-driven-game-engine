...
auto core::image::png::Image::load_from(const std::filesystem::path& filepath) -> Image
{
    // TODO: request format
...
auto core::image::png::Image::load_from(const std::span<const std::byte> data) -> Image
{
    // TODO: request format
    constexpr static vk::Format format{ vk::Format::eR8G8B8A8Srgb };
...
auto core::image::png::Image::data() const noexcept -> std::span<const std::byte>
{
    return m_data;
}

auto core::image::png::Image::width() const noexcept -> uint32_t
{
    return m_base_width;
}

auto core::image::png::Image::height() const noexcept -> uint32_t
{
    return m_base_height;
}

auto core::image::png::Image::depth() const noexcept -> uint32_t
{
    return 1;
}

auto core::image::png::Image::mip_level_count() const noexcept -> uint32_t
{
    return m_mip_level_count;
}

auto core::image::png::Image::needs_mip_generation() const noexcept -> bool
{
    return false;
}

auto core::image::png::Image::format() const noexcept -> vk::Format
{
    return m_format;
}

auto core::image::png::Image::offset_of(
