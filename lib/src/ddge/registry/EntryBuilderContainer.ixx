...
export module ddge.registry.EntryBuilderContainer;

import ddge.registry.DependencyChainNode;
import ddge.registry.EntryBase;
import ddge.registry.EntryBuilderBase;
import ddge.registry.strip_dependency_t;
import ddge.registry.Registry;
import ddge.registry.ReverseDependencyChainNode;
