...
export module ddge.scheduler.TaskHubBuilder;

import ddge.scheduler.locks.create_lock_group;
import ddge.scheduler.locks.LockGroup;
import ddge.scheduler.Nexus;
import ddge.scheduler.provide_accessors_for;
import ddge.scheduler.raw_task_c;
import ddge.scheduler.data_structures.Work;
import ddge.scheduler.EmbeddedTaskBody;
import ddge.scheduler.EmbeddedTaskFactory;
import ddge.scheduler.ErasedTaskFactory;
...
import ddge.scheduler.TaskFactoryProxy;
...
template <typename Result_T>
auto ddge::scheduler::TaskHubBuilder::set_task_continuation_factory(
...
template <typename Self_T>
auto ddge::scheduler::TaskHubBuilder::get(this Self_T&& self, const TaskIndex task_index)
    -> util::meta::forward_like_t<ErasedTaskFactory, Self_T>
{
