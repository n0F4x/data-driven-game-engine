...
export module ddge.scheduler.accessors.messages.Provider;

import ddge.app;
import ddge.messages;
import ddge.scheduler.accessors.messages.Mailbox;
import ddge.scheduler.accessors.messages.Receiver;
import ddge.scheduler.accessors.messages.Sender;
