...
export module ddge.app.extensions.AddonsPlugin;

import ddge.app.addon_c;
import ddge.app.decays_to_addon_c;
...
public:
    ...
    template <decays_to_app_c App_T>
...
public:
    template <decays_to_builder_c Self_T, decays_to_addon_c Addon_T>
    constexpr auto use_addon(this Self_T&&, Addon_T&& addon);

    template <decays_to_builder_c Self_T, decays_to_addon_maker AddonMaker_T>
