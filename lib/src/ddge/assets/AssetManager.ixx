...
export module ddge.assets.AssetManager;
...
public:
    explicit AssetManager(util::GenericStack&& cached_loaders);
...
private:
    util::GenericStack m_cached_loaders;
};

}   // namespace ddge::assets

ddge::assets::AssetManager::AssetManager(ddge::util::GenericStack&& cached_loaders)
