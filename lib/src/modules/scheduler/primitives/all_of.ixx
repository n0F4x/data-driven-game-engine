...
export module modules.scheduler.primitives.all_of;
...
export template <converts_to_task_builder_c... TaskBuilders_T>
    requires(
        std::same_as<typename as_task_builder_t<TaskBuilders_T>::Result, bool>
        && ...
    )
[[nodiscard]]
...
template <modules::scheduler::converts_to_task_builder_c... TaskBuilders_T>
    requires(
        std::same_as<typename modules::scheduler::as_task_builder_t<TaskBuilders_T>::Result, bool>
        && ...
    )
auto modules::scheduler::primitives::all_of(TaskBuilders_T&&... task_builders)
    -> TaskBuilder<bool>
{
