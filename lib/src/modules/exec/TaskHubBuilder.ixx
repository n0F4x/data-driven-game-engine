...
export module ddge.modules.exec.TaskHubBuilder;
...
import ddge.modules.exec.EmbeddedTaskBody;
import ddge.modules.exec.EmbeddedTaskFactory;
import ddge.modules.exec.ErasedTaskFactory;
...
auto ddge::exec::TaskHubBuilder::emplace_embedded_task(
    F&&        task,
    ExecPolicy execution_policy
) -> TypedTaskIndex<util::meta::result_of_t<F>>
{
...
template <typename Result_T>
auto ddge::exec::TaskHubBuilder::emplace_indirect_task_factory(
    IndirectTaskFactory<Result_T>&& indirect_task_factory
) -> TypedTaskIndex<Result_T>
{
...
template <typename Result_T>
auto ddge::exec::TaskHubBuilder::set_task_continuation_factory(
...
template <typename Self_T>
auto ddge::exec::TaskHubBuilder::select_task_factories(
    this Self_T&&   self,
...
template <typename Self_T>
auto ddge::exec::TaskHubBuilder::get(this Self_T&& self, const TaskIndex task_index)
    -> util::meta::forward_like_t<ErasedTaskFactory, Self_T>
{
...
template <typename Result_T>
auto ddge::exec::TaskHubBuilder::emplace(
    EmbeddedTaskFactory<Result_T>&& embedded_task_factory,
