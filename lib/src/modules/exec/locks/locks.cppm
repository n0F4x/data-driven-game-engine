export module ddge.modules.exec.locks;
...
export import ddge.modules.exec.locks.LockedResourceID;
export import ddge.modules.exec.locks.LockGroup;
export import ddge.modules.exec.locks.LockOwnerIndex;
export import ddge.modules.exec.locks.SharedCriticalSection;
export import ddge.modules.exec.locks.TopOfLockStack;
