...
export module ddge.modules.exec.TaskBuilderBundle;
...
auto ddge::exec::TaskBuilderBundle<Result_T>::emplace(TaskBuilder<Result_T>&& task_builder)
    -> void
{
...
template <typename Result_T>
auto ddge::exec::TaskBuilderBundle<Result_T>::emplace(
...
template <typename Result_T>
template <ddge::exec::gatherer_builder_of_c<Result_T> GathererBuilder_T>
auto ddge::exec::TaskBuilderBundle<Result_T>::sync(
    GathererBuilder_T&& gatherer_builder
) && -> TaskBuilder<typename GathererBuilder_T::Result>
{
