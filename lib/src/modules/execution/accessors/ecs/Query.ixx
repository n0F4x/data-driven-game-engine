...
export module ddge.modules.execution.accessors.ecs.Query;
...
template <ddge::ecs::query_parameter_c... Parameters_T>
    requires(sizeof...(Parameters_T) != 0)
ddge::exec::accessors::ecs::Query<Parameters_T...>::Query(
...
template <ddge::ecs::query_parameter_c... Parameters_T>
    requires(sizeof...(Parameters_T) != 0)
template <typename F>
auto ddge::exec::accessors::ecs::Query<Parameters_T...>::for_each(F&& func) -> F
{
...
template <ddge::ecs::query_parameter_c... Parameters_T>
    requires(sizeof...(Parameters_T) != 0)
auto ddge::exec::accessors::Query<Parameters_T...>::count() -> std::size_t
{
