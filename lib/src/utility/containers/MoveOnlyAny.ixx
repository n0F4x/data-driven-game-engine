...
template <typename T, std::size_t size_T, std::size_t alignment_T, util::meta::generic_allocator_c Allocator_T>
struct Traits;
...
template <std::size_t size_T, std::size_t alignment_T, ::util::meta::generic_allocator_c Allocator_T>
