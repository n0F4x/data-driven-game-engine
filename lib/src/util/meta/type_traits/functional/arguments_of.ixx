...
export module ddge.util.meta.type_traits.functional.arguments_of;
...
import ddge.util.meta.concepts.functional.unambiguous_implicit_functor;
import ddge.util.meta.concepts.functional.unambiguous_static_functor;
import ddge.util.meta.concepts.functional.unambiguously_invocable;
import ddge.util.meta.type_traits.functional.Signature;
import ddge.util.meta.type_traits.type_list.type_list_drop_front;
